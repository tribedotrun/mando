...
pub use paths::{
    bin_dir, captain_lock_path, cc_streams_dir, cron_store_path, data_dir, detect_github_repo,
    expand_tilde, first_project_path, images_dir, logs_dir, match_project_by_prefix,
    parse_github_slug, plans_dir, resolve_github_repo, resolve_project_config, slugify, state_dir,
