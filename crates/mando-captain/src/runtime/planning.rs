...
async fn run_planner_step(
    ...
    let prompt = mando_config::render_prompt("planning_initial", &workflow.prompts, &vars)
    ...
    let builder = super::tick_spawn::with_credential(builder, credential);
...
async fn run_cc_feedback(
    ...
    let prompt = mando_config::render_prompt("planning_cc_feedback", &workflow.prompts, &vars)
...
async fn run_codex_feedback(
    ...
    let prompt =
        mando_config::render_prompt("planning_codex_feedback", &workflow.prompts, &vars)
...
async fn run_synthesizer(
    ...
    let prompt = mando_config::render_prompt("planning_synthesize", &workflow.prompts, &vars)
...
async fn run_final_synthesis(
    ...
    let prompt = mando_config::render_prompt("planning_final", &workflow.prompts, &vars)
