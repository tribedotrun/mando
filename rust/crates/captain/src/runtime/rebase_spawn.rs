...
pub(super) async fn handle_conflict(
    ...
    if rebase_retries >= max_rebase_retries {
        ...
        let event = crate::TimelineEvent {
            ...
            data: TimelineEventPayload::CaptainReviewRebaseExhausted {
                trigger: "rebase_exhausted".to_string(),
                pr: pr.to_string(),
                retries: max_rebase_retries as i64,
                reason: "rebase_exhausted".to_string(),
            },
        };
