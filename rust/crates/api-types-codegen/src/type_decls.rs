...
pub fn known_type_decls() -> BTreeMap<String, String> {
    ...
    register_roots!(
        ...
        api_types::AddCodexCredentialRequest,
        api_types::AddCodexCredentialResponse,
        api_types::CancelCodexLoginResponse,
        api_types::CodexCredentialAddWarning,
        api_types::CodexCredentialDetails,
        api_types::CodexCredentialPick,
        api_types::CodexCredentialPickResponse,
        api_types::CodexLoginFlowInfo,
        api_types::CodexLoginStatus,
        api_types::CodexLoginStatusResponse,
        api_types::CodexResetCredit,
        api_types::CodexResetCreditsResponse,
        api_types::StartCodexLoginRequest,
        api_types::StartCodexLoginResponse,
        api_types::SyncCodexCredentialRequest,
        api_types::SyncCodexCredentialResponse,
        api_types::CredentialInfo,
        api_types::CredentialProvider,
        api_types::CredentialMutationResponse,
        api_types::CredentialPick,
        api_types::CredentialPickRequest,
        api_types::CredentialPickResponse,
        ...
        api_types::ScoutItemStatusFilter,
        ...
        api_types::UpdateCodexCredentialAuthRequest,
        api_types::UpdateCredentialTokenRequest,
        api_types::UpdateCredentialTokenResponse,
        api_types::UserContextConfig,
        api_types::WorkbenchEventData,
        api_types::WorkbenchIdParams,
        api_types::WorkbenchItem,
        api_types::WorkbenchStatusFilter,
        ...
        api_types::TranscriptEvent,
        api_types::TranscriptEventEnvelope,
        api_types::TranscriptEventsResponse,
        api_types::TranscriptSnapshotBatch,
        api_types::TranscriptSnapshotComplete,
        api_types::TranscriptConnectionClosed,
        api_types::TranscriptStreamError,
        api_types::SystemInitEvent,
        api_types::SystemCompactBoundaryEvent,
        api_types::SystemStatusEvent,
        api_types::SystemApiRetryEvent,
        api_types::SystemLocalCommandOutputEvent,
        api_types::SystemThinkingTokensEvent,
        api_types::UserEvent,
        api_types::AssistantEvent,
        api_types::ToolProgressEvent,
        api_types::ResultEvent,
        api_types::ResultOutcome,
        api_types::ResultSummary,
        api_types::PermissionDenial,
        api_types::UnknownEvent,
        api_types::EventMeta,
        api_types::EventIndex,
        api_types::McpServerStatus,
        api_types::CcPermissionMode,
        api_types::UserContentBlock,
        api_types::UserTextBlock,
        api_types::UserImageBlock,
        api_types::UserToolResultBlock,
        api_types::ToolResultContent,
        api_types::ToolResultText,
        api_types::ToolResultBlocks,
        api_types::ToolResultChildBlock,
        api_types::ToolResultUnknownBlock,
        api_types::AssistantContentBlock,
        api_types::AssistantTextBlock,
        api_types::AssistantThinkingBlock,
        api_types::AssistantToolUseBlock,
        api_types::ToolName,
        api_types::McpToolName,
        api_types::OtherToolName,
        api_types::ToolInput,
        api_types::BashInput,
        api_types::ReadInput,
        api_types::EditInput,
        api_types::WriteInput,
        api_types::GrepInput,
        api_types::GrepOutputMode,
        api_types::GlobInput,
        api_types::TodoWriteInput,
        api_types::CcTodoItem,
        api_types::CcTodoItemStatus,
        api_types::WebFetchInput,
        api_types::WebSearchInput,
        api_types::TaskInput,
        api_types::NotebookEditInput,
        api_types::NotebookCellType,
        api_types::NotebookEditMode,
        api_types::SkillInput,
        api_types::StructuredOutputInput,
        api_types::OpaqueInput,
        api_types::ModelUsageBreakdown
    );
