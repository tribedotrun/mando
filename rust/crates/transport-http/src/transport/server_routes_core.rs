...
use crate::transport::{
    ...
    routes_credentials_codex, routes_credentials_codex_app, routes_credentials_codex_login,
    routes_credentials_update, routes_sessions, routes_stats, routes_workbenches, sse,
    sse_session_events,
};
...
pub(crate) fn protected_routes() -> ApiRouter<AppState> {
    task_routes()
        ...
        .merge(crate::transport::routes_credential_routing::credential_routing_routes())
