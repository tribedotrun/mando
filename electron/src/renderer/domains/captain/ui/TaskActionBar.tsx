...
import { ActionBarToolbar, ImageChip } from '#renderer/domains/captain/ui/ActionBarToolbar';
...
export function TaskActionBar({ item, onAsk }: Props): React.ReactElement | null {
  ...
  const { image, preview, setImageFile, removeImage } = useImageAttachment(item.id);
