...
interface MarkdownImageQAChatProps extends Omit<QAChatFrameProps, 'composer' | 'AssistantMessage'> {
...
export function MarkdownImageQAChat({
  ...
  formStyle,
  ...surfaceProps
}: MarkdownImageQAChatProps): React.ReactElement {
...
export type { QAEntry } from '#renderer/domains/scout/service/qaTypes';
