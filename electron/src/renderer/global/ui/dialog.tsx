...
} from '#renderer/global/ui/dialog-parts';
...
function DialogContent(props: React.ComponentProps<typeof DialogPrimitive.Content>) {
  return <DialogContentFrame closeButton={<DialogChromeCloseButton />} {...props} />;
}

function DialogContentPlain(props: React.ComponentProps<typeof DialogPrimitive.Content>) {
