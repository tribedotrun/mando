...
} from '#renderer/global/ui/primitives/context-menu-parts';
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-2 py-1.5 text-caption font-medium text-foreground data-[inset]:pl-8',
        className,
      )}
      {...props}
    />
