...
import { useBulkCreateStore, type BulkCreatePhase } from '#renderer/stores/bulkCreateStore';
...
export function BulkCreateProgress(): React.ReactElement | null {
  ...
  return (
    <>
      ...
      `}</style>
      <div
        className="fixed z-[350] flex items-center gap-2.5 rounded-lg px-4 py-2.5"
        style={{
          bottom: 16,
          left: 16,
