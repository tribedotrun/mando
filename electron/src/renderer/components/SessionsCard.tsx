...
import { StatusFilterMenu } from '#renderer/components/StatusFilterMenu';
import {
        ...
        return (
          ...
          >
            ...
            <span className="shrink-0" style={{ width: 8 }}>
              <span
                className={`inline-block h-1.5 w-1.5 rounded-full${s.status === 'running' ? ' animate-pulse' : ''}`}
                style={{ background: STATUS_COLOR[s.status] ?? STATUS_COLOR.stopped }}
              />
            </span>
